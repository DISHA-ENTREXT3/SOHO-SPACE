...
export const RocketLaunchIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a6 6 0 01-7.38 5.84m2.56-5.84a6 6 0 01-5.84-7.38m5.84 2.56a6 6 0 017.38-5.84m-2.56 5.84a6 6 0 01-7.38-5.84m-5.84 7.38a6 6 0 01-5.84-7.38 6 6 0 0112.12 0v-3.47m-6.12 3.47a6 6 0 01-5.84-7.38" />
    </svg>
);
...
export const UserGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.28-2.72a3 3 0 00-4.682-2.72 9.094 9.094 0 003.741-.479m-1.258 5.485A3 3 0 019 16.5a3 3 0 01-3.741-2.23m11.23-2.23a3 3 0 01-3.741 2.23m-7.482 0a3 3 0 01-3.741-2.23M12 10.5a3.375 3.375 0 100-6.75 3.375 3.375 0 000 6.75z" />
    </svg>
);
...
export const PresentationChartLineIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 1.5m1-1.5l1 1.5m0 0l.5 1.5m.5-1.5l.5-1.5m-1.5 4.5l-1.5-1.5m1.5 1.5l1.5-1.5m1.5 1.5l-1.5-1.5m1.5 1.5l1.5-1.5M12 9.75l-1.5 1.5m1.5-1.5l1.5 1.5" />
    </svg>
);
...
export const PuzzlePieceIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.66.538-1.192 1.193-1.192h1.114c.655 0 1.193.532 1.193 1.192v.421c0 .43-.238.835-.635 1.058l-2.09 1.12c-.417.223-.95.223-1.367 0l-2.09-1.12a1.192 1.192 0 01-.635-1.058v-.421c0-.66.538-1.192 1.193-1.192h1.114c.655 0 1.193.532 1.193 1.192zM14.25 18c0 .66.538 1.192 1.193 1.192h1.114c.655 0 1.193-.532 1.193-1.192v-.421c0-.43-.238-.835-.635-1.058l-2.09-1.12c-.417-.223-.95.223-1.367 0l-2.09 1.12a1.192 1.192 0 00-.635 1.058v.421c0 .66.538 1.192 1.193 1.192h1.114c.655 0 1.193.532 1.193 1.192zM6 12c0 .66.538 1.192 1.193 1.192h1.114c.655 0 1.193-.532 1.193-1.192v-.421c0-.43-.238-.835-.635-1.058l-2.09-1.12c-.417-.223-.95-.223-1.367 0L4.436 9.47a1.192 1.192 0 00-.635 1.058v.421c0 .66.538 1.192 1.193 1.192h1.114c.655 0 1.193.532 1.193-1.192zM18 12c0 .66.538 1.192 1.193 1.192h1.114c.655 0 1.193-.532 1.193-1.192v-.421c0-.43-.238-.835-.635-1.058l-2.09-1.12c-.417-.223-.95-.223-1.367 0l-2.09 1.12a1.192 1.192 0 00-.635 1.058v.421c0 .66.538 1.192 1.193 1.192h1.114c.655 0 1.193.532 1.193-1.192z" />
    </svg>
);
...
export const BriefcaseIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.972 2.4-2.223 2.493-1.44.108-2.577-1.04-2.577-2.348V14.15M15.75 14.15v4.875c0 1.508-1.217 2.725-2.725 2.725S10.25 20.533 10.25 19.025V14.15M3.75 14.15v4.075c0 1.313.972 2.4 2.223 2.493-1.44.108 2.577-1.04 2.577-2.348V14.15M8.25 14.15v4.875c0 1.508 1.217 2.725 2.725 2.725s2.725-1.217 2.725-2.725V14.15" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 6.75c-1.036 0-1.875.84-1.875 1.875v.375c0 1.036.84 1.875 1.875 1.875h16.5c1.036 0 1.875-.84 1.875-1.875v-.375c0-1.036-.84-1.875-1.875-1.875H3.75z" />
    </svg>
);

export const StarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.31h5.418a.563.563 0 01.313.951l-4.125 3.14a.563.563 0 00-.18.625l1.625 4.875a.563.563 0 01-.813.625l-4.375-3.14a.563.563 0 00-.625 0l-4.375 3.14a.563.563 0 01-.813-.625l1.625-4.875a.563.563 0 00-.18-.625l-4.125-3.14a.563.563 0 01.313-.951h5.418a.563.563 0 00.475-.31L11.48 3.5z" />
    </svg>
);

// FIX: Added missing BookmarkIcon component
export const BookmarkIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 3h14a2 2 0 012 2v16l-7-4-7 4V5a2 2 0 012-2z" />
    </svg>
);
...
export const DocumentPlusIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9.75v5.25m0 0l-2.25-2.25m2.25 2.25l2.25-2.25M3.375 5.25c0-1.036.84-1.875 1.875-1.875h.375m13.5 0h.375c1.036 0 1.875.84 1.875 1.875v13.5c0 1.036-.84 1.875-1.875 1.875h-13.5c-1.036 0-1.875-.84-1.875-1.875v-13.5z" />
    </svg>
);

export const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311V21m-3.75-2.311v-.697a2.25 2.25 0 012.25-2.25c.578 0 1.082.215 1.47.552a2.25 2.25 0 011.47-.552c1.243 0 2.25 1.007 2.25 2.25v.697m-4.5-5.25c.282-.162.583-.295.894-.401m-1.189.401c-.282.162-.583.295-.894.401m1.189-1.408c.383-.22.78-.403 1.189-.556M4.5 12.75a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 0115 0" />
    </svg>
);
...
export const GlobeAltIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c.333 0 .664-.026.992-.075M21 12a9 9 0 00-9-9 .563.563 0 00-.563.563v1.513a.563.563 0 01-.563.563H4.5a9 9 0 009 9z" />
    </svg>
);
...
export const TrophyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 011.056-4.321 9.75 9.75 0 018.788-4.321 9.75 9.75 0 018.788 4.321A9.75 9.75 0 0116.5 18.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25v5.25m-4.5-5.25v5.25m9-5.25v5.25M9 3.75l3 3 3-3M6.75 3.75h10.5a2.25 2.25 0 012.25 2.25v3.75a2.25 2.25 0 01-2.25-2.25H6.75a2.25 2.25 0 01-2.25-2.25V6a2.25 2.25 0 012.25-2.25z" />
    </svg>
);
...
export const Cog6ToothIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 007.5 7.5 7.5 7.5 0 007.5-7.5m-15 0a7.5 7.5 0 017.5-7.5 7.5 7.5 0 017.5 7.5m-7.5 7.5V21m-3-3l-1.5 1.5M18 18l-1.5-1.5M6 6l-1.5-1.5M18 6l-1.5 1.5" />
    </svg>
);
...
export const SubstackIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M22.539 8.242H1.46V5.414h21.08v2.828zM1.46 10.812V24L12 18.11L22.54 24V10.812H1.46zM22.54 0H1.46v2.83h21.08V0z"/>
    </svg>
);
